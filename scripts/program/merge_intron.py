...
os.chdir("/home/tigs/noncod/nmgd_run/out/intron")
...
# Load all files
df_base = pd.read_csv("intron2.tsv", sep="\t")
df_gtex = pd.read_csv("intron_gtex_separated.tsv", sep="\t")
df_favor = pd.read_csv("intron_favor_separated.tsv", sep="\t")
df_prom = pd.read_csv("prom_intron.tsv", sep="\t")
df_remm = pd.read_csv("remm_intron.tsv", sep="\t")
df_splice = pd.read_csv("intron_spliceds.tsv", sep="\t")
df_pang = pd.read_csv("intron_pangds.tsv", sep="\t")
...
# Save to file
merged_df.to_csv("merged_intron_annotations.tsv", sep="\t", index=False)

print("✅ Merged file saved as 'merged_intron_annotations.tsv'")
